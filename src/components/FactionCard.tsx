...
export default function FactionCard({ name, tagline, description, color, features, sovereignPath, factionPath }: FactionCardProps) {
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 gap-6 pt-6 border-t border-white/5">
          <motion.div 
            whileHover={{ x: 5 }}
            className="space-y-3 p-4 rounded-lg bg-black/40 border border-white/5 hover:border-yellow-500/30 transition-colors"
          >
            <div className="flex items-center gap-2 text-yellow-500 font-display font-bold text-sm uppercase tracking-widest">
              <Crown size={16} />
              Sovereign Path
            </div>
          ...
          <motion.div 
            whileHover={{ x: 5 }}
            className="space-y-3 p-4 rounded-lg bg-black/40 border border-white/5 hover:border-terminal-green/30 transition-colors"
          >
            <div className="flex items-center gap-2 text-terminal-green font-display font-bold text-sm uppercase tracking-widest">
              <Shield size={16} />
              Faction Path
            </div>
            <p className="text-[11px] text-gray-400 leading-relaxed italic">
